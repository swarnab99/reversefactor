		...
		<section className='container mt-14'>
			<div className='row gx-lg-8 gx-xl-12 gy-10 gy-lg-0'>
				<div className='col-lg-4'>
					<h3 className='display-4 mb-3 pe-xl-10'>Proven Results</h3>
					<p className='lead fs-lg mb-0 pe-xxl-10'>
						When your right intention is matched with your consistent effort &
						discipline, your health changes for the better.
					</p>
				...
				<div className='col-lg-8 mt-lg-2'>
					<div className='row align-items-center counter-wrapper gy-6 text-center'>
						<div className='col-md-4'>
							...
							<p>People have been empowered with right information</p>
						</div>
						...
						<div className='col-md-4'>
							...
							<h3 className='counter'>4,000 +</h3>
							<p>People reversed their lifestyle diseases with right food</p>
						</div>
						...
						<div className='col-md-4'>
							<svg
								...
								<path
									className='lineal-stroke'
									d='M299.9 104.7h-23.8V56.5c0-18.1-14.6-32.7-32.7-32.7h-77.2c-18 0-32.7 14.7-32.7 32.7v48.2h-23.8V56.5C109.8 25.3 135 0 166.2 0h77.2c31.2 0 56.4 25.3 56.5 56.5v48.2z'></path>
								<path
									className='lineal-stroke'
									d='M360.5 380.8H49.1c-27.1 0-49-22-49.1-49.1V119.1C0 92 22 70 49.1 70h311.5c27.1 0 49 22 49.1 49.1v212.7c-.1 27.1-22.1 49-49.2 49zM49.1 93.8c-14 0-25.3 11.3-25.3 25.3v212.7c0 14 11.3 25.3 25.3 25.3h311.5c14 0 25.3-11.3 25.3-25.3V119.1c0-14-11.3-25.3-25.3-25.3H49.1z'></path>
								<path
									className='lineal-fill'
									d='M49.2 81.7c-18.4 0-33.3 14.8-33.3 33.2 0 2.7.3 5.3.9 7.9C35.4 197.9 103.6 254 184.2 254h41.2c80.6 0 148.8-56.1 167.3-131.2 4.3-17.8-6.6-35.8-24.5-40.2-2.6-.6-5.2-.9-7.9-.9H49.2z'></path>
								<path
									className='lineal-stroke'
								...
								<path
									className='lineal-fill'
									d='M128.5 288.5h-13.8c-8.9 0-16.1-7.2-16.1-16.1v-48.3c0-8.9 7.2-16.1 16.1-16.1h13.8c8.9 0 16.1 7.2 16.1 16.1v48.3c0 8.9-7.2 16.1-16.1 16.1z'></path>
								<path
									className='lineal-stroke'
									d='M128.5 300.4h-13.8c-15.5 0-28-12.5-28-28v-48.3c0-15.5 12.5-28 28-28h13.8c15.5 0 28 12.5 28 28v48.3c0 15.5-12.5 28-28 28zm-13.8-80.5c-2.3 0-4.2 1.9-4.2 4.2v48.3c0 2.3 1.9 4.2 4.2 4.2h13.8c2.3 0 4.2-1.9 4.2-4.2v-48.3c0-2.3-1.9-4.2-4.2-4.2h-13.8z'></path>
								<path
									className='lineal-fill'
									d='M294.9 288.5h-13.8c-8.9 0-16.1-7.2-16.1-16.1v-48.3c0-8.9 7.2-16.1 16.1-16.1h13.8c8.9 0 16.1 7.2 16.1 16.1v48.3c0 8.9-7.2 16.1-16.1 16.1z'></path>
								<path
									className='lineal-stroke'
									d='M294.9 300.4h-13.8c-15.5 0-28-12.5-28-28v-48.3c0-15.5 12.5-28 28-28h13.8c15.5 0 28 12.5 28 28v48.3c0 15.5-12.5 28-28 28zm-13.8-80.5c-2.3 0-4.2 1.9-4.2 4.2v48.3c0 2.3 1.9 4.2 4.2 4.2h13.8c2.3 0 4.2-1.9 4.2-4.2v-48.3c0-2.3-1.9-4.2-4.2-4.2h-13.8z'></path>
							</svg>
							<h3 className='counter'>75% +</h3>
							<p>Average decrease in medications in our program</p>
						</div>
					</div>
				</div>
			</div>
