				...
				<div className='row gx-lg-8 gx-xl-12 gy-10 align-items-center'>
					<div className='col-lg-5'>
						...
						<h3 className='display-4 mb-5'>
							Prevent, Reverse & Manage Diseases - Digitally!
						</h3>
						<p>
							...
							<div className='col-md-6 align-self-start'>
								<div className='card bg-pale-primary'>
									<div className='card-body'>
										...
										<h4>Constant support and monitoring</h4>
										<p className='mb-0'>
											Nulla vitae elit libero, a pharetra augue. Donec id elit
											non mi porta gravida at eget.
										</p>
